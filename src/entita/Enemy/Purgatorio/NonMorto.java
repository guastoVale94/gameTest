package entita.Enemy.Purgatorio;
...
public class NonMorto extends Creature {
    ...
    public NonMorto(Handler handler, float x, float y) {
        super(handler, x, y, Creature.DEFAULT_CREATURE_WIDTH * 2+15, Creature.DEFAULT_CREATURE_HEIGHT * 2+15);
        left = false;//parti con il nemico rivolto verso sinistra
        up = false;
        //right = false;
        nemico_left = new Animation(500, Assets.nonMorto_left);
        nemico_right = new Animation(500, Assets.nonMorto_right);
        nemico_up = new Animation(500, Assets.nonMorto_up);
        nemico_down = new Animation(500, Assets.nonMorto_down);
        nemico_attack = new Animation(500, Assets.nonMorto_attack);
        this.setSpeed(1.5f);
    }
