...
public class AnimaUpDown extends Creature {
    ...
    public AnimaUpDown(Handler handler, float x, float y) {
    ...
    public void tick() {
        ...
        moveLeftRight();
        move();
        if (this.getY() == 100) {// anziche mettere i numeri,per rendere generico???
            //right = true;
            up = false;
