...
public class Anima extends Creature {
    ...
    public Anima(Handler handler, float x, float y) {
        ...
        up = false;
        //right = false;
        nemico_left = new Animation(500, Assets.anima_left);
        nemico_right = new Animation(500, Assets.anima_right);
        nemico_up = new Animation(500, Assets.anima_up);
        nemico_down = new Animation(500, Assets.anima_down);
        nemico_attack = new Animation(500, Assets.anima_attack);
        this.setSpeed(1.5f);
    }
