...
public class SpiritoDiFuoco extends Creature {
    ...
    public SpiritoDiFuoco(Handler handler, float x, float y) {
        ...
        up = false;
        //right = false;
        nemico_left = new Animation(500, Assets.spiritoFuoco_left);
        nemico_right = new Animation(500, Assets.spiritoFuoco_right);
        nemico_up = new Animation(500, Assets.spiritoFuoco_up);
        nemico_down = new Animation(500, Assets.spiritoFuoco_down);
        nemico_attack = new Animation(500, Assets.spiritoFuoco_attack);
        this.setSpeed(1.5f);
    }
